...
uint256 hashGenesisBlock("0x2db8e66684326a426bba0106ee00d75790799c91f5c161ab4edea6795150c018");
...
const string strMessageMagic = "donorcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.5 * 24 * 60 * 60; // donorcoin: 0.5 days
static const int64 nTargetSpacing = 240; // donorcoin: 4 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal donorcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "donorcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x028aa5d965a0fa970adce52cdd6f7bb44e39eb48ad035163857e53bce82e23f3");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1415499120";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415586755; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 798083;

        if (fTestNet)
        {
            block.nTime    = 1415499120;
            block.nNonce   = 3904263;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3cf3dab1b48291b7b68baba85a78c02821025dc21a7f0bedc466127fcc5d966d"));
